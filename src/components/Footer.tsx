        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="mt-6 text-gray-400 max-w-md">
              GleamGlow brings luxury to every space with our premium cleaning services. We define elegance through our meticulous attention to detail, ensuring each environment shines with brilliance.
            </p>
