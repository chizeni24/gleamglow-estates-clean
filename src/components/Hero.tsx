      ...
      <div className="container-custom relative z-10 text-center">
        <div className="max-w-3xl mx-auto">
          <div className="mb-8">
            ...
            <div className="inline-block px-4 py-1 bg-gold-lighter/20 backdrop-blur-sm rounded-full">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            <Link to="/booking" className="btn-gold relative overflow-hidden group">
              ...
              <span className="absolute inset-0 bg-gradient-to-r from-gold-dark via-gold to-gold-lighter opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
            </Link>
            <a href="#services" className="border-2 border-gold-lighter text-gold-lighter hover:bg-gold-lighter hover:text-white transition-colors duration-300 px-8 py-3 rounded-md font-medium">
